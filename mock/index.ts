export default {
  ...
  'POST /api/getMenu': (req:any, res:any) => {
    let obj = {
      code:0,
      data:[
        // {code:'001', name:'可是朱云', parentCode:'-1', icon:'', color:''},
        // {code:'001.001', name:'明', parentCode:'001', icon:'', color:'',url:'/but/home'},
        // {code:'001.002', name:'白', parentCode:'001', icon:'', color:'',url:'/but/login'},
        // {code:'001.003', name:'context传值', parentCode:'001', icon:'', color:'',url:'/but/propsContext'},
        // {code:'001.004', name:'才哥哥直播脱衣', parentCode:'001', icon:'', color:'',url:'/but/video'},
        //
        // {code:'002', name:'这样的男人', parentCode:'-1', icon:'', color:''},
        ...
        {code:'003.001', name:'一些特效', parentCode:'003', icon:'', color:'',url:'/style/specialCSS'},
        {code:'003.002', name:'一些tit样式', parentCode:'003', icon:'', color:'',url:'/style/animationPage'},

        {code:'001', name:'这可是好东西啊', parentCode:'-1', icon:'', color:''},
        {code:'001.001', name:'深拷贝和浅拷贝', parentCode:'001', icon:'', color:'',url:'/note/deep'},
        {code:'001.002', name:'怎么获取sourceTree的key', parentCode:'001', icon:'', color:'',url:'/note/InstructionsOfKey'},
      ]
    };
    setTimeout(() => {
      res.send(obj);
